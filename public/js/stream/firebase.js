...
fb.realtime.TransportManager.prototype.initTransports_ = function() {
  var isWebSocketsAvailable = false;//fb.realtime.WebSocketConnection && fb.realtime.WebSocketConnection["isAvailable"]();
  var isSkipPollConnection = true;//isWebSocketsAvailable && !fb.core.storage.PersistentStorage.get("previous_websocket_failure");
  var transports = [];
