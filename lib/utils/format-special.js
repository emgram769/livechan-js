...
var aussie_cities = ["Brisbane", "Canberra", "Darwin", "Gold Coast", "Melbourne", "Newcastle", "Perth", "Sunshine", "Sydney"];
	    ...
	    if (c_data) {
	        ...
	        switch (c_data.country_code) {
		        case "US":
		        	...
		        	break;
		        case "AU":
		        	if (c_data.city && aussie_cities.indexOf(c_data.city) > -1)
		        		data.country += "-"+c_data.city;
					break;
		        default:
		        	if (c_data.region && regional_flags.indexOf(data.country+"-"+c_data.region) > -1)
						data.country += "-"+c_data.region;
		        	break;
	        }
